...
//	private int[] coinXY = new int[2];
	...
	public List<Integer[]> getMaze() {
		...
		try (BufferedReader br = new BufferedReader(
			new FileReader(DATABASE_PATH + File.separator + "MazeLevel"+randomLevel+".ini"));) { // 미로랜덤으로 돌리게 변경
//			new FileReader(DATABASE_PATH + File.separator + "MazeLevel1.ini"));) { // 2번미로 잘되는지 확인
	...
	public static void main(String[] args) {
		...
		System.out.println(" 유령 초기 위치 : " + mazeLv0.getGhostInitLocation());
		System.out.println(" 팩보이 초기 위치 : " + mazeLv0.getPacboyInitLocation());
		System.out.println("coinMap size : " + coinMap.size());
		for (int[] xy : coinMap) {
